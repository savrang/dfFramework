...
public class dfJoystickInput : MonoBehaviour
#if !UNITY_EDITOR
...
#endif
{
    ...
    public JoystickDirection JoystickMoveAxis = JoystickDirection.BOTH;
    ...
    private dfVirtualAxis _horizintalAxis;
    private dfVirtualAxis _verticalAxis;
...
#if UNITY_EDITOR
        gameObject.AddComponent<dfJoystickInputHelper>();
#endif
    }
    ...
    private void OnDisable()
    {
        ...
        dfInputManager.Instance.UnregisterVirtualAxis(_horizintalAxis);
        dfInputManager.Instance.UnregisterVirtualAxis(_verticalAxis);
    }
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        _horizintalAxis._value = _verticalAxis._value = 0f;
        ...
        if (dfInputManager.Instance._delegateTouchUp != null)
            dfInputManager.Instance._delegateTouchUp();
    }
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        if (dfInputManager.Instance._delegateTouchDown != null)
            dfInputManager.Instance._delegateTouchDown();
    }
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        if ((JoystickMoveAxis & JoystickDirection.HORIZONTAL) == 0)
        {
            stickAnchoredPosition.x = _intermediateStickPosition.x;
        }
        if ((JoystickMoveAxis & JoystickDirection.VERTICAL) == 0)
        {
        ...
        _horizintalAxis._value = horizontalValue;
        _verticalAxis._value = verticalValue;
    }
